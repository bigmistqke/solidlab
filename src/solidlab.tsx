          ...
          <div class={styles.dialogBody}>
            <div>
              ...
              <div class={styles.dialogOptions}>
                <button>
                  <Codicon kind="new-file" class={styles.dialogButtonIcon} />
                  <span class={styles.dialogButtonTitle}>New Project</span>
                </button>
                <button>
                  <Codicon kind="save" class={styles.dialogButtonIcon} />
                  <span class={styles.dialogButtonTitle}>Save Project</span>
                </button>
                <div class={styles.dialogSeparator} />
                <button>
                  <Codicon kind="folder-opened" class={styles.dialogButtonIcon} />
                  <span class={styles.dialogButtonTitle}>Open Project</span>
                </button>
                <button>
                  <Codicon kind="arrow-down" class={styles.dialogButtonIcon} />
            ...
            <div class={styles.dialogColumn}>
              ...
              <div class={styles.dialogOptions}>
                <button>
                  <Codicon kind="share" class={styles.dialogButtonIcon} />
                  <span class={styles.dialogButtonTitle}>Share Project</span>
                </button>
                <button>
                  <Codicon kind="file-zip" class={styles.dialogButtonIcon} />
                  <span class={styles.dialogButtonTitle}>Export As Zip</span>
                </button>
                <button>
                  <Codicon kind="github" class={styles.dialogButtonIcon} />
                  <span class={styles.dialogButtonTitle}>Publish To Github</span>
                </button>
                <div class={styles.dialogSeparator} />
                <div class={styles.dialogOption}>
                  <button>
                    <Codicon kind="check" class={styles.dialogButtonIcon} />
                    ...
                    <Popover.Portal>
                      <Popover.Content class={styles.popoverContent}>
                        ...
                        <Popover.Description class={styles.popoverDescription}>
                          ...
                          mode is not suited for SolidStart applications, but can be useful for
